...
class RNNCell(nn.Module):
    def __init__(self, input_size,
        ...
        self.W_x = np.random.randn(hidden_size, input_size) * np.sqrt(2.0 / (input_size + hidden_size))

        self.U_h = np.random.randn(hidden_size, hidden_size) * np.sqrt(2.0 / (hidden_size + hidden_size))
